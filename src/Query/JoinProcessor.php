...
abstract final class JoinProcessor {
	 ...
	 */
	protected static function addJoinFilterExpression(?Expression $filter, string $left_column, string $right_column): BinaryOperatorExpression {

		$left = new ColumnExpression(shape('type' => TokenType::IDENTIFIER, 'value' => $left_column, 'raw' => $left_column));
		$right = new ColumnExpression(shape('type' => TokenType::IDENTIFIER, 'value' => $right_column, 'raw' => $right_column));
